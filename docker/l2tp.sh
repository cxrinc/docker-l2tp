...
# It's based from https://github.com/teddysun/across
...
if [ ! -f /config/chap-secrets ]; then
	touch /config/chap-secrets /config/passwd
	chmod 600 /config/chap-secrets /config/passwd
fi

rm -f /etc/ppp/chap-secrets /etc/ipsec.d/passwd
ln -s /config/chap-secrets /etc/ppp/chap-secrets
ln -s /config/passwd /etc/ipsec.d/passwd
